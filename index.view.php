...
<body>
    ...
    <section id="presentacion" class="presentacion-fondo">
        <div class="item-fondo"><img src="./img/Recurso 6.png" alt="Error 404"></div>
    </section>
    ...
    <section class="sec-carousel">
        <div class="content-banner">
            <img src="./img/banner-facebook-builtech.png" alt="Error 404" title="Promocion">
        </div>
    </section>
    ...
    <div class="content-wha">
        <a href="https://api.whatsapp.com/send/?phone=3320525516&text=Hola%20Building%20Technology,%20%C2%BFMe%20puedes%20ayudar?&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer"><img src="./img/whatsapp.png" alt="Whastapp" title="Ingresar WhatsApp"></a>
    </div> 
